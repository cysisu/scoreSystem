			...
			<div class="form-horizontal col-sm-offset-3 col-md-offset-3" id="login_form">
				...
				<div class="col-sm-9 col-md-9">
					<div class="form-group">
						...
						<input class="form-control required" type="text" placeholder="studentId or teacherId" id="login_username" name="username" autofocus="autofocus" maxlength="20"/>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
                    		...
                    		<input class="form-control required" type="text" placeholder="student or teacher" id="login_character" name="character" maxlength="8"/>
                    </div>
					<div class="form-group">
					...
					<div class="form-group">
						<input type="submit" class="btn btn-success pull-right" id="login_btn" value="Login "/>
					</div>
				</div>
			</div>
		</div>
