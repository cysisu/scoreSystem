 ...
 <div class="layui-form-item" >
    <div class="layui-inline" style="margin-top:10px">
      ...
      <div class="layui-input-inline">
        <input type="text" id="teacherId"  name="teacherId"  autocomplete="off" class="layui-input" style="width:140px">
      </div>
    </div>
    <div class="layui-inline" style="margin-top:10px">
...
layui.use(['jquery', 'table', 'layer', 'form'], function(){
  ...
  table.render({
    ...
    ,cols: [[
      ...
      ,{field:'teacherId', title:'老师编号', width:300, align:'center',sort: true}
